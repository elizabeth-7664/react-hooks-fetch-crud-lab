...
function App() {
  ...
  return (
    <main>
      ...
      {page === "Form" ? <QuestionForm  onAddQuestion={handleAddQuestions}/> : <QuestionList questions={questions} onDeleteQuestion={handledeleteQuestions} onUpdateQuestion={handleUpdateQuestions}/>}
    </main>
  );
}
